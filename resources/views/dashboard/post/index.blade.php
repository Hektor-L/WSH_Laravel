        ...
        <div class="col-lg-8">
            ...
            @foreach ($posts as $post)
                <tr>
                    ...
                    <td><a href="{{ route('dashboard.posts.view', $post->id) }}" class="btn btn-outline-primary"><i class="bi bi-pencil-square"></i> Edit</a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="{{ route('dashboard.posts.delete', $post->id) }}" role="button" class="btn btn-primary">Confirm</a>
                                </div>
                            </div>
                        </div>
                    </div>
