...
Route::middleware(['auth', 'verified'])->group(function() {
    ...
    Route::get('/dashboard/posts/create',           [CommentController::class, 'create'])->name('dashboard.posts.create');
    Route::post('/dashboard/posts',                 [CommentController::class, 'store'])->name('dashboard.posts.store');
    Route::get('/dashboard/posts/{id}/view',        [CommentController::class, 'view'])->name('dashboard.posts.view');
    Route::post('/dashboard/posts/{id}/update',     [CommentController::class, 'update'])->name('dashboard.posts.update');
    Route::get('/dashboard/posts/{id}/delete',     [CommentController::class, 'destroy'])->name('dashboard.posts.delete');
    Route::get('/dashboard/posts/search',           [CommentController::class, 'search'])->name('dashboard.posts.search');
});
